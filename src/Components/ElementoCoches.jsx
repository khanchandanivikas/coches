...
const ElementoCoches = (props) => {
  const coche = props.element;
  const [nuevoEliminar, setNuevoEliminar] = useState(props.element.id);
  ...
  const handleNuevoEliminar = () => {
    setNuevoEliminar(props.element.id);
  };
